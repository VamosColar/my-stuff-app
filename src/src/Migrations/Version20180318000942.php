 ...
 */
class Version20180318000942 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE funcao (id_funcao INT AUTO_INCREMENT NOT NULL, func_nome VARCHAR(255) NOT NULL, PRIMARY KEY(id_funcao)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
